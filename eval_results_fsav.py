...
datamodule_conf = {
    ...
    "subset_name": args.subset_name, #"none", 
    "dl_kw":{
        "batch_size": 32
    },
...
#     if k == 0:
#         count = 1
#         rows = np.array([litmodel.solver.varc, litmodel.solver.obsc, litmodel.solver.pc])
#     else:
#         count += 1
#         rows += np.array([litmodel.solver.varc, litmodel.solver.obsc, litmodel.solver.pc])
# np.savetxt("/home/triet/Bureau/EEG/code/bilevel_esi/outputs/res_GD_conv.csv", rows/count, delimiter=",", fmt='%.15f')
